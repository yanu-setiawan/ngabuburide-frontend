            ...
            <div className=" flex mt-8 flex-col">
              ...
              <div className=" flex flex-col md:flex-row gap-3 mb-10">
                <div className=" flex gap-3">
                  ...
                  <div>
                    <button className="btn w-[9.375rem] h-[3.8rem] bg-blackSec font-bold ">
                      Add To Cart
                    </button>
                  </div>
                  <div>
              ...
              <div className=" text-xs leading-7">
                <p>
                  SKU: N/A <br /> Categories: Furniture, Interior, Chair <br />
                  Tag: Furniture, Chair, Scandinavian, <br /> Modern Product ID:
                  274
                </p>
              </div>
